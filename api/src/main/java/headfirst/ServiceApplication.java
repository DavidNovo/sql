...
import headfirst.bundles.GuiceBundleProvider;
import headfirst.handlers.ParameterHandlerProvider;
...
public class ServiceApplication extends Application<ServiceConfiguration> {
    ...
    private BeanConfig getPublicSwagger(final Environment environment) {
        ...
        swagConfig.setTitle("sql API");
        swagConfig.setDescription("sql API");
        ...
        swagConfig.setContact("admin@sql.com");
